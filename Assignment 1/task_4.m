...
f= @(x) sin(x);
sin_min = fminbnd(f,0.5,1)


% Create a function computing x^2 + 1 (elementwise) of the input array elements using the anonymous function syntax, 
% and store the handle to variable 'f'
